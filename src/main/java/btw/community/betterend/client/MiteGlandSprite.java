...
public class MiteGlandSprite extends TextureAtlasSprite {
    private final String baseTextureName;

    public MiteGlandSprite(String iconName, String baseTextureName) {
        super(iconName);
    ...
    public void loadSprite(Resource par1Resource) throws IOException {
        String domain = "btw";
        String path = "textures/items/witch_wart.png";
        ...
        try {
            ...
            System.err.println("BetterEnd: Could not load base texture for Mite Gland: " + baseLocation);
        }
